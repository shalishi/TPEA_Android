...
public abstract class CursorRecyclerViewAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public CursorRecyclerViewAdapter(Context context, Cursor cursor, FragmentManager fm) {
        mContext = context;
        mCursor = cursor;
        mfm=fm;
    ...
    public void onBindViewHolder(VH viewHolder, int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* String urlFeed= mCursor.getString(mCursor.getColumnIndex(Souscription.ADDRESS)) ;
                Intent intent =new Intent(mContext, SousFeedActivity.class);
                intent.putExtra("urlFeed",urlFeed);
